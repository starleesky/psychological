...
public class CookieUtils {
	...
	public static final String COOKIE_KEY_TICKET = "cart";
	 ...
	 * @param domain
	 */
	public static void addCart(HttpServletResponse response, String ticket, String domain) {
		add(response, COOKIE_KEY_TICKET, ticket, domain);
	}
	
	public static void removeCart(HttpServletRequest request,HttpServletResponse response, String domain) {
		remove(request,response,domain,COOKIE_KEY_TICKET);
	}
