define(function (require) {
	...
	.controller('mainCtrl', ['$scope', 'commonList', 'citys', '$modal', 'referrer', '$http',
		function ($scope, commonList, citys, $modal, referrer, $http) {
			...
			list.url = "/promotion/referrer/list/getdata";
			...
			$scope.resetCache = function () {
				if (confirm('确定刷新？')) {
					$http.post(angular.path + '/promotion/referrer/add/synch/do')
			...
			// 查看明细
			$scope.showDetail = function (refId) {

				$modal.open({
					templateUrl: angular.path + '/resources/templates/promotion/referrer-detail.html',
					controller: 'referrerDetailCtrl',
					backdrop: 'static',
					size: 'lg',
					resolve: {
						refId: function () {
