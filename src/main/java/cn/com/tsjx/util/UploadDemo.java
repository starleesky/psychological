...
public class UploadDemo {
	...
	public static void main(String args[]) throws IOException {
		...
		String FilePath = "F:/IMG_0286.JPG";
		uploadDemo.uploadImgs(FilePath, "9");
		uploadDemo.uploadImgs(FilePath, "10");
		uploadDemo.uploadImgs(FilePath, "11");
		uploadDemo.uploadImgs(FilePath, "12");
	}
