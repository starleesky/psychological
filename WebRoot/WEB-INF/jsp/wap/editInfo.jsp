    ...
    <div class="page-view-body">
        ...
        <section class="mod-want-buy">
            <form class="ui-form" id="informationFrom">
                ...
                <input type="hidden" id="_bigCataId" value="${bean.catagoryBigId }">
                <input type="hidden" id="_midCataId" value="${bean.catagoryMidId }">
                <input type="hidden" id="_CataId" value="${bean.catagoryId }">
                <input type="hidden" id="_brandId" value="${bean.brandId }">
                <input type="hidden" id="_modelId" value="${bean.modelId }">
...
<script type="text/javascript">
    var ctx = "${ctx}";
    require(['module/want-release','module/editInfo']);
</script>
</body></html>
