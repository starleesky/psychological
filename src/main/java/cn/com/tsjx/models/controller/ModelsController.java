...
public class ModelsController {
	...
	public String list(Pager<cn.com.tsjx.models.entity.Models> pager, cn.com.tsjx.models.entity.Models models,
			Model model) {
	...
	public String input(Long id, Model model) {
		cn.com.tsjx.models.entity.Models models = new cn.com.tsjx.models.entity.Models();
		if (id != null) {
	...
	public String save(cn.com.tsjx.models.entity.Models models, Model model) {
	...
	public String update(cn.com.tsjx.models.entity.Models models, Model model) {
