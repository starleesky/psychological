...
public final class ChineseCalendar extends GregorianCalendar {
    ...
    public static void main(String[] args) {
        ...
        ChineseCalendar cc = new ChineseCalendar(cal);
        // 农历日期字符串
        System.out.println(cc.getChineseDateString());
        // 农历节日
        System.out.println(cc.getLunarFestival());
        // 公历节日
        System.out.println(cc.getChinese(SOLAR_FESTIVAL));
        // 农历日期
        System.out.println(cc.getChinese(CHINESE_DATE));
    }
}