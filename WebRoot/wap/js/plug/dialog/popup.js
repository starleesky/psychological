...
define(function(require) {
    ...
    $.extend(Popup.prototype, {
        ...
        show : function(anchor) {
            ...
            this.open = true;
            this.follow = (anchor && $(anchor)[0]) || this.follow;
        ...
        time : function() {
            ...
            if (typeof arguments[0] == 'number') {
                autoTime = arguments[0];
            } else if (typeof arguments[1] == 'number') {
                autoTime = arguments[1];
            }

            var _dailog = this.show.apply(this, arguments);
            if (autoTime) {
                var _this = this;
                (function(_this) {
                    setTimeout(function() {
        ...
        __follow : function(anchor) {
            ...
            var width = $elem ? $elem[0].clientWidth : 0;
            var height = $elem ? $elem[0].clientHeight : 0;
    ...
    // aliases
    Popup.prototype.on = Popup.prototype.addEventListener;
    Popup.prototype.un = Popup.prototype.removeEventListener;
    Popup.prototype.emit = Popup.prototype.__dispatchEvent;
